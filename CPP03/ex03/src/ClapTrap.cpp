...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/20 17:57:33 by dsteiger          #+#    #+#             */
/*   Updated: 2025/10/20 17:57:34 by dsteiger         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
	...
	_EnergyPoints = 10;
	_AttackDamage = 0;
	std::cout << YELLOW << "> ClapTrap3 default constructor activated" << RESET << std::endl;
}
...
ClapTrap::ClapTrap(std::string name)
{
	...
	_EnergyPoints = 10;
	_AttackDamage = 0;
	std::cout << YELLOW << "> ClapTrap3 constructor activated" << RESET << std::endl;
}
...
ClapTrap::ClapTrap(ClapTrap const &copy)
{
	...
	std::cout << GREEN << "> ClapTrap3 copy constructor activated" << RESET << std::endl;
}
...
ClapTrap &ClapTrap::operator=(ClapTrap const &copy)
{
	...
	std::cout << BLUE << "> ClapTrap3 assignment operator activated" << RESET << std::endl;
	return (*this);
}

ClapTrap::~ClapTrap()
{
	std::cout << RED << "> ClapTrap3 destructor activated" << RESET << std::endl;
}
